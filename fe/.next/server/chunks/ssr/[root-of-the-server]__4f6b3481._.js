...
"[project]/src/app/claimtravel/addexpense/page.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ClaimTravel() {
    ...
    // 🔹 Fetch data dari API
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        fetch("/api/sections/13").then((res)=>res.json()).then((data)=>{
            // Tambahkan id otomatis ke setiap <h2> yang valid
            const fixedContent = data.data.content.replace(/<h2[^>]*>([\s\S]*?)<\/h2>/g, (match, title)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const observer = new MutationObserver(()=>{
            ...
            if (headings.length > 0) {
                const list = Array.from(headings).filter((h)=>h.id && h.textContent.trim() !== "").map((h)=>({
                        id: h.id,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const observer = new IntersectionObserver((entries)=>{
            const visible = entries.filter((entry)=>entry.isIntersecting && entry.intersectionRatio >= 0.5).sort((a, b)=>a.boundingClientRect.top - b.boundingClientRect.top);
            if (visible.length > 0) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4f6b3481._.js.map