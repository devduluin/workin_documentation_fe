...
export default function AddNewEventsCalendarSidebar() {
  const sections = [
    { id: "status1", title: "Basic Information" },
    { id: "status2", title: "Content" },
    { id: "status3", title: "Navigasi & Aksi" },
    { id: "status4", title: "Catatan" },
  ];
