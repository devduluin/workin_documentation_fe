...
export default function HRMSSettingSidebar() {
  const sections = [
    { id: "status1", title: "Navigasi" },
    { id: "status2", title: "Employee Settings" },
    { id: "status3", title: "Shift Settings" },
    { id: "status4", title: "Catatan Penting" },
    { id: "status5", title: "Tips Implementasi" },
  ];
