...
export default function ShiftAttendanceSidebar() {
  const sections = [
    { id: "page", title: "Attendance" },
    { id: "page2", title: "Checkpoint" },
    { id: "page3", title: "Shift Management" },
    { id: "page4", title: "Report & Tools" },
    { id: "gambar-dashboard", title: "Gambar Dashboard" },
  ];
