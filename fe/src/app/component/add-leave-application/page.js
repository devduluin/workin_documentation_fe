...
export default function AddLeaveApplicationSidebar() {
  const sections = [
    { id: "status1", title: "Employee Leave" },
    { id: "status2", title: "Data & Reason" },
    { id: "status3", title: "Approval" },
    { id: "status4", title: "Tombol Aksi" },
  ];
