...
export default function EventsCalendarSidebar() {
  const sections = [
    { id: "status1", title: "Tampilan Kalender" },
    { id: "status2", title: "Tombol" },
    { id: "status3", title: "Add" },
    { id: "status4", title: "Tips Penggunaan" },
    { id: "status5", title: "Catatan" },
  ];
