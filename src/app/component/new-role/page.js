...
export default function NewRoleSidebar() {
  const sections = [
    { id: "status1", title: "Lokasi Menu" },
    { id: "status2", title: "Field Input" },
    { id: "status3", title: "Tombol Aksi" },
    { id: "status4", title: "Langkah-langkah" },
    { id: "status5", title: "Tips" },
  ];
