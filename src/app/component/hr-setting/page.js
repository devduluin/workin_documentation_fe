...
export default function HRSettingSidebar() {
  const sections = [
    { id: "status1", title: "Komponen Utama" },
    { id: "status2", title: "Cara Penggunaan" },
    { id: "status3", title: "Catatan Penting" },
    { id: "status4", title: "Tips Implementasi" },
  ];
