...
export default function DeactivationAccountSidebar() {
  const sections = [
    { id: "status1", title: "Lokasi" },
    { id: "status2", title: "Informasi" },
    { id: "status3", title: "Langkah-langkah" },
    { id: "status4", title: "Pembatalan Proses" },
    { id: "status5", title: "Tombol" },
    { id: "status6", title: "Catatan Penting" },
  ];
