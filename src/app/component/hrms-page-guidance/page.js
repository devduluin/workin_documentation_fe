...
export default function HRMSPageGuidanceSidebar() {
  const sections = [
    { id: "status1", title: "Employee Settings" },
    { id: "status2", title: "Shift Settings" },
    { id: "status3", title: "Attendance Settings" },
    { id: "status4", title: "Other Settings" },
  ];
