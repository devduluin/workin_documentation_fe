...
export default function EmployeeLeaveSidebar() {
  const sections = [
    { id: "status1", title: "Rekapitulasi Cuti" },
    { id: "status2", title: "Jenis Cuti & Jumlah Penggunaan" },
    { id: "status3", title: "More Acrion" },
    { id: "status4", title: "Tips Tambahan" },
  ];
