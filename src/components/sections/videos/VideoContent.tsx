    ...
    <div className="group card-interactive !rounded-2xl overflow-hidden">
      ...
      <div className="p-4">
        <div className="flex items-start gap-3">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-violet-100 to-indigo-100 flex items-center justify-center shrink-0 mt-0.5 group-hover:from-violet-200 group-hover:to-indigo-200 transition-colors">
